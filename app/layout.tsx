...
export const metadata: Metadata = {
  ...
  description: "Premium fresh oysters from Port Lavaca, Texas. Sustainable Gulf Coast oysters for restaurants, events & seafood lovers. Order online or call (713) 854-7427.",
  keywords: [
    "Texas oysters",
    "Port Lavaca oysters", 
    "Gulf Coast oysters",
