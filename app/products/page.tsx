          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2 md:space-x-4">
              <nav className="flex space-x-2 md:space-x-4">
                ...
                <Link href="/products" className="text-teal-600 font-medium text-xs md:text-base">
                  Products
                </Link>
                <Link
                  href="/inventory"
                  className="text-purple-700 hover:text-teal-600 font-medium text-xs md:text-base"
                >
                  Inventory
                </Link>
