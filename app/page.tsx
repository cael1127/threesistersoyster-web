...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-purpleBrand via-lavenderBrand via-blueBrand via-mintBrand to-seafoamBrand">
      ...
      {/* Contact Section */}
      <section id="contact" className="py-20 px-4 bg-gradient-to-b from-blue-900/20 to-purple-900/20">
        <div className="container mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-4">
                <a
                  ...
                  className="flex items-center text-white hover:text-purple-200 transition-colors duration-200 group"
                >
                  <Phone className="w-5 h-5 text-purple-300 mr-3 group-hover:text-purple-200 transition-colors duration-200" />
                ...
                <a
                  ...
                  className="flex items-center text-white hover:text-purple-200 transition-colors duration-200 group"
                >
                  <Mail className="w-5 h-5 text-purple-300 mr-3 group-hover:text-purple-200 transition-colors duration-200" />
                ...
                <a
                  ...
                  className="flex items-center text-white hover:text-purple-200 transition-colors duration-200 group"
                >
                  <MapPin className="w-5 h-5 text-purple-300 mr-3 group-hover:text-purple-200 transition-colors duration-200" />
              ...
              <div className="mt-8">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-white hover:text-purple-200 transition-colors duration-200 hover:underline"
                >
            ...
            <Card className="border-purple-300/30 bg-gradient-to-b from-purple-900/40 to-blue-900/40 backdrop-blur-sm">
