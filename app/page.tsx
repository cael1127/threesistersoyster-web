            ...
            <div className="flex items-center space-x-1 md:space-x-4">
              ...
              <div className="flex md:hidden items-center w-full">
                ...
                <nav className="flex items-center flex-1 px-4">
                  <Link href="/products" className="text-white hover:text-purple-100 font-medium text-xs py-2 flex-1 text-center">
                    Shop
                  </Link>
                  <Link href="/inventory" className="text-white hover:text-purple-100 font-medium text-xs py-2 flex-1 text-center">
                    Stock
                  </Link>
                  <Link href="/gallery" className="text-white hover:text-purple-100 font-medium text-xs py-2 flex-1 text-center">
                    Gallery
                  </Link>
                  <Link href="/about" className="text-white hover:text-purple-100 font-medium text-xs py-2 flex-1 text-center">
                    About
                  </Link>
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
                <Button
                  asChild
                  size="lg"
                  className="bg-purple-600 hover:bg-purple-700 text-white min-h-[48px] text-base shadow-lg"
                >
                ...
                <Button
                  asChild
                  size="lg"
                  className="bg-teal-600 hover:bg-teal-700 text-white min-h-[48px] text-base shadow-lg"
                >
            ...
            <div className="relative">
              <div className="aspect-video bg-gradient-to-br from-purple-100 to-teal-100 rounded-2xl overflow-hidden shadow-2xl">
                <video
                  autoPlay
                  muted
                  loop
                ...
                >
                  ...
                  <div className="w-full h-full bg-gradient-to-br from-purple-100 to-teal-100 flex items-center justify-center">
                    <span className="text-purple-600 text-lg">Video loading...</span>
                  </div>
                </video>
              </div>
            </div>
      ...
      <section className="py-12 md:py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {/* Nursery Card */}
            <Card className="border-teal-200 bg-white hover:shadow-xl transition-shadow duration-300">
              <CardContent className="p-6 md:p-8">
                <div className="flex items-center mb-4 md:mb-6">
                  ...
                  <h3 className="text-xl md:text-2xl font-bold text-teal-800 text-center">Oyster Nursery</h3>
                </div>
                ...
                <p className="text-xs md:text-sm text-gray-600">
                  ...
                  <a href="tel:713-854-7427" className="font-semibold text-teal-600 hover:text-teal-700 transition-colors duration-200">
                    713-854-7427
                  </a>
                </p>
              </CardContent>
            ...
            {/* Farm Card */}
            <Card className="border-purple-200 bg-white hover:shadow-xl transition-shadow duration-300">
              <CardContent className="p-6 md:p-8">
                <div className="flex items-center mb-4 md:mb-6">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-full overflow-hidden flex items-center justify-center mr-3 md:mr-4">
                    <Image
                  ...
                  <h3 className="text-xl md:text-2xl font-bold text-purple-800 text-center">Oyster Farm</h3>
                </div>
                <p className="text-sm md:text-base text-gray-600 mb-4 md:mb-6 leading-relaxed">
      ...
      <section id="about" className="py-12 md:py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="relative">
              <div className="aspect-square bg-gradient-to-br from-purple-100 to-teal-100 rounded-2xl flex items-center justify-center border border-purple-200">
                <Image
                  src="/aboutpic.jpg"
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-purple-800 mb-2 text-center">Water Quality</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-teal-800 mb-2 text-center">Carbon Sequestration</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-blue-800 mb-2 text-center">Marine Habitat</h3>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-4">
                ...
                >
                  <Phone className="w-5 h-5 text-purple-500 mr-3 group-hover:text-purple-600 transition-colors duration-200" />
                ...
                <a
                  ...
                  className="flex items-center text-gray-600 hover:text-purple-600 transition-colors duration-200 group"
                >
                  <Mail className="w-5 h-5 text-purple-500 mr-3 group-hover:text-purple-600 transition-colors duration-200" />
                ...
                <a
                  ...
                  className="flex items-center text-gray-600 hover:text-purple-600 transition-colors duration-200 group"
                >
                  <MapPin className="w-5 h-5 text-purple-500 mr-3 group-hover:text-purple-600 transition-colors duration-200" />
